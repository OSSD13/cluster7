        ...
        <div class="flex flex-col w-64 bg-white shadow-md">
            ...
            <div class="px-4 py-4 border-b border-gray-200">
                <div class="flex items-center">
                    <div class="flex items-center justify-center w-10 h-10 mr-3 rounded-full shadow-sm bg-primary-500">
                ...
                <div class="px-1 py-1 mt-2 text-sm font-medium text-center text-gray-700 bg-gray-100 rounded-full">
            ...
            <!-- User Profile Card -->
            <div class="px-4 py-4 border-b border-gray-200">
                <div class="p-3 rounded-lg shadow-sm bg-gray-50">
                    <div class="flex items-center">
                        <div class="flex-shrink-0">
                            <div class="flex items-center justify-center w-12 h-12 rounded-full bg-primary-100">
                                <span class="text-lg font-bold text-primary-700">{{ substr(auth()->user()->name, 0, 1) }}</span>
                            </div>
                        </div>
                        ...
                        <form method="POST" action="{{ route('logout') }}">
                            @csrf
                            <button type="submit" class="p-1 text-gray-600 rounded-full hover:text-gray-900 hover:bg-gray-200">
            ...
            <div class="flex-grow px-2 py-4">
                <div class="px-4 py-2 mb-4">
                    <p class="text-xs font-semibold tracking-wider text-gray-500 uppercase">Main Menu</p>
                </div>
                ...
                <div class="px-4 py-2 mt-4 mb-2">
                    <p class="text-xs font-semibold tracking-wider text-gray-500 uppercase">Reports</p>
                </div>
                ...
                <a href="{{ route('minorcases') }}" class="block px-4 py-2 rounded-lg mb-1 {{ request()->routeIs('minorcases') ? 'bg-primary-50 text-primary-700' : 'text-gray-600 hover:bg-gray-100' }}">
                    <div class="flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-3" width="16" height="16" fill="currentColor" class="bi bi-hash" viewBox="0 0 16 16">
                ...
                <div class="px-4 py-2 mt-6 mb-4">
                    <p class="text-xs font-semibold tracking-wider text-gray-500 uppercase">Admin Settings</p>
                </div>
            ...
            <div class="px-4 py-3 border-t border-gray-200">
                <p class="text-xs text-center text-gray-500">v{{ config('app.version', '1.0') }}</p>
            </div>
        </div>

        <!-- Main Content -->
        <div class="flex flex-col flex-1">
            <main class="flex-1 px-4 py-6 overflow-auto sm:px-6 lg:px-8">
                @if(session('success'))
                    <div class="p-4 mx-auto mb-4 text-green-700 bg-green-100 border-l-4 border-green-500 rounded max-w-7xl" role="alert">
                        <p>{{ session('success') }}</p>
                    </div>
                @endif

                @if(session('error'))
                    <div class="p-4 mx-auto mb-4 text-red-700 bg-red-100 border-l-4 border-red-500 rounded max-w-7xl" role="alert">
                        <p>{{ session('error') }}</p>
                    </div>
                @endif
