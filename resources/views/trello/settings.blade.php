...
<div class="ml-3 pt-4 mx-right">
    ...
    <div class="p-6 mb-10 bg-white rounded-3xl border-b border-gray-200">
        <form method="POST" action="{{ route('trello.settings.update') }}" id="settings-form">
            ...
            <div class="flex items-center justify-center space-x-4 pt-6 pb-3">
                ...
                <button
                    type="submit"
                    class="bg-primary-400 hover:bg-sky-500 hover:text-white text-white font-bold py-2 px-4 rounded-full focus:outline-none focus:shadow-outline"
                >
                    Save Settings
                </button>
            </div>
    ...
    <div class="p-6 mb-10 bg-white rounded-3xl">
    <div class="flex items-center ">
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="17" fill="#13A7FD" class="bi bi-exclamation-circle" viewBox="0 0 16 16">
                <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14m0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16"/>
                <path d="M7.002 11a1 1 0 1 1 2 0 1 1 0 0 1-2 0M7.1 4.995a.905.905 0 1 1 1.8 0l-.35 3.507a.552.552 0 0 1-1.1 0z"/>
            </svg>
        <h3 class="font-bold text-lg text-gray-900 mb-2.5 mt-2 ml-2">How to get your Trello API credentials</h3>
    </div>
        ...
        <div>
            <h3 class="text-lg font-bold text-gray-900 mb-2">Additional Settings</h3>
            ...
            <div class="space-y-4 mt-1">
                <div class="flex items-start">
                    ...
                    <div class="ml-3">
                        ...
                        <a href="{{ route('settings.sprint') }}" class="mt-2 inline-flex items-center px-3 py-1.5 border border-primary-300 shadow-sm text-sm leading-4 font-medium rounded-full text-primary-400 bg-white hover:bg-primary-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500">
